...
DSMC_StarTimeHourMin        	= 5         -- 1-> 9. hour 0-24 that will be used as minimum in the start mission time randomization, valid only with DSMC_UpdateStartTime set to true and DSMC_UpdateStartTime_mode set to "2". Out of the defined range, the value will be set as "4"
DSMC_StarTimeHourMax        	= 10        -- 10-> 23. hour 0-24 that will be used as maximum in the start mission time randomization, valid only with DSMC_UpdateStartTime set to true and DSMC_UpdateStartTime_mode set to "2". Out of the defined range, the value will be set as "16"
...
DSMC_AutosaveExit_hours			= 12        -- value, 1->24 or 25. hours of simulation after with DCS closes, from 0 to 24 (higher values won't be accepted). If clients are online, it will delay 5 minutes and so on till nobody is online.
DSMC_AutosaveExit_time      	= 2         -- value, 1->23. hour at witch DCS will automatically close regardless of clients or other settings. works only if DSMC_AutosaveExit_hours is set to >24. Values out of the 1-23 range will be ignored.
...
DSMC_DCSR_clientPilotOnly       = true    -- true / false. If True, only client downed pilots will generate CSAR mission.
...
DSMC_CTLD_Limit_APC             = 30       -- number
DSMC_CTLD_Limit_IFV             = 30       -- number
DSMC_CTLD_Limit_Tanks           = 20        -- number
DSMC_CTLD_Limit_ads             = 20        -- number
DSMC_CTLD_Limit_Arty            = 20        -- number
DSMC_CTLD_Limit_Trucks          = 20       -- number
